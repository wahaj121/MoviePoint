...
$result22 = $connection->query($sql);
$sqll = "SELECT COUNT(*) as total_tic FROM `ticket`";
$result2 = $connection->query($sqll);
if ($result2->num_rows > 0) {
    $tic = $result2->fetch_assoc();
    } else {
    echo "0 Comments";
    } 
?> 
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
					...
					<a href="ticket.php" class="nav-item nav-link active "><i class="fa fa-ticket-alt me-2"></i>Tickets</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href=""><?php echo "{$tic['total_tic']}";?>&nbsp;Tickets</a>
                    </div>
                    ...
                    <!-- <th scope="col"><img class="rounded-c/ircle flex-shrink-0" src="img/user.jpg" alt="" style="width: 40px; height: 40px;"></th> -->
                                    ...
                                    <th style="text-align: center" scope="col">Seats</th>
									<th style="text-align: center" scope="col">Theater</th>
                            ...
                            <tbody>
                                ...
                                <td style="text-align:center;"><a class="btn btn-danger" href="delete.php?id=<?php echo $row['id']; ?>&table=ticket">Delete</a></td>
                                </tr>
                                <?php       
                                    }
                                    }
