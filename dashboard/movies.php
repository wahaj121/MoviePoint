...
$sqll = "SELECT COUNT(*) as total_movies FROM `movies`";
$result2 = $connection->query($sqll);
if ($result2->num_rows > 0) {
    $comm = $result2->fetch_assoc();
    } else {
    echo "0 Movies";
    } 
?> 
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="movies.php" class="nav-item nav-link  active"><i class="fa fa-film me-2"></i>Movies</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <a href=""><?php echo "{$comm['total_movies']}";?>&nbsp;Movies</a>&nbsp;&nbsp;&nbsp;
                    ...
                    <!-- <th scope="col"><img class="rounded-c/ircle flex-shrink-0" src="img/user.jpg" alt="" style="width: 40px; height: 40px;"></th> -->
                                    ...
                                    <th style="text-align: center" scope="col">Movie Name</th>
                                    <th style="text-align: center" scope="col">Movie Image</th>
                                    <th style="text-align: center" scope="col">Youtube Links</th>
                            ...
                            <?php
                                ...
                                <td style="text-align: center"> <?php echo '<img class="" src="../m_image/' . $row['m_image'] . '" style="width: 6rem; height: 7rem; title="' . $row['m_image'] . '">'; ?></td>
                                
                                <td><?php echo $row['y_link']; ?></td>

                                <td style="text-align: center"><a class="btn btn-info" href="editmovie.php?id=<?php echo $row['id']; ?>">Edit</a>&nbsp;<a class="btn btn-danger" href="delete.php?id=<?php echo $row['id']; ?>&table=movies">Delete</a></td>
                                </tr>
                                <?php       
                                    }
                                    }
