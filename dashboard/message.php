...
$sqll = "SELECT COUNT(*) as total_message FROM `messagebox`";
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="message.php" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Contact us</a>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href=""><?php echo "{$mes['total_message']}";?>&nbsp;Messages</a>
                    ...
                    <!-- <th scope="col"><img class="rounded-c/ircle flex-shrink-0" src="img/user.jpg" alt="" style="width: 40px; height: 40px;"></th> -->
                            ...
                            <?php
                                ...
                                <td style="text-align:center;"><a class="btn btn-danger" href="delete.php?id=<?php echo $row['id']; ?>&table=messagebox">Delete</a></td>
                                </tr>
                                <?php       
                                    }
                                    }
