...
if ($result3->num_rows > 0) {
    ...
    if (isset($_POST['Update'])) {
        ...
        $temp_name = $_FILES['m_image']['tmp_name'];
        $upload_dir = "../m_image/";
...
if (mysqli_query($connection, $updateQuery)) {
    echo "<script>alert('Movie updated successfully!'); window.location = 'movies.php';</script>";
} else {
...
$movieResult = $connection->query($movieQuery);
...
<div class="form-style-5">
    <form action="" method="post" enctype="multipart/form-data">
        <input type="number" hidden name="id" value="<?php echo $movieData['id']; ?>" placeholder="Id">
        <label for="">Movie Image</label>
        <input type="file" name="m_image" value="<?php echo $movieData['m_image']; ?>" placeholder="Movie Image" style="margin-bottom:1rem;">
        <label for="">Movie Name</label>
        <input type="text" name="m_name" value="<?php echo $movieData['movie_name']; ?>" placeholder="Movie Name">
        <label for="">Youtube Link</label>
        <input type="text" name="m_link" value="<?php echo $movieData['y_link']; ?>" placeholder="Youtube Link">
