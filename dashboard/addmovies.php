...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <input type="file" name="image" value="" placeholder="Images" style="margin-bottom:1rem;">
        <label for="">Movie Name</label>
        <input type="text" name="name" value="" placeholder="Image Name">
        <label for="">Youtube Link</label>
        <input type="text" name="y_link" value="" placeholder="Youtube Link">
...
<?php
 ...
 if (isset($_POST['Upload'])) {
    ...
    $updateQuery = "INSERT INTO `movies` (`id`, `movie_name`, `m_image`, `y_link`) VALUES (NULL, '$M_Name', '$image' , '$y_links');";

    if (mysqli_query($connection, $updateQuery)) {
        echo "<script>alert('Movie Add successfully'); window.location = 'movies.php';</script>";
    } else {
        echo "<script>alert('Error uploading record: " . mysqli_error($connection) . "');</script>";
    }
}
